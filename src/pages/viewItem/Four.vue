  ...
  <v-row style="padding-top: 40px">
    <v-col cols="12" sm="12" md="3" lg="3" class="view-banner" :style="{ 'border-color': primaryColor }">
      <view-title-banner 
        ...
        title="4 Lives AI"
        subtitle="AI-generated information resource for video games"
    ...
    <v-col offset-md="2" offset-lg="2">
      <div class="view-text" 
        ...
        <overview title="4 Lives AI" :color="secondaryColor">
          ...
          <template #image>
            <v-img v-if="$vuetify.display.smAndDown" class="mx-auto" width="125" style="max-width:inherit" :src="imgSrc('logo-fl.png')" />
            <v-img v-else height="150" :src="imgSrc('logo-fl.png')" />
          </template>
        </overview>
        ...
        <ideate :color="primaryColor">
          ...
          <template #logo1>
            <v-img class="pt-1" height="125" :src="imgSrc('logo-fl.png')" />
          </template>
          <template #logo2>
            <p>
          ...
          <template #color>
            <v-row justify="space-evenly" class="py-8"> 
              <v-col cols="11" class="py-3">
                <v-img width="80%" class="mx-auto" :src="imgSrc('fl-sticker.png')" />
              </v-col>
            </v-row>
          </template>
        </ideate>
