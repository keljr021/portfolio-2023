...
<template>
    <v-container>
        ...
        <v-row id="logos" class="mb-15" justify="start" justify-sm="center" justify-md="center" justify-lg="center" v-intersect="onIntersect">
            <v-col cols="12" v-if="$vuetify.display.xs" class="work-section-title text-center">Logos</v-col>
            <v-col cols="12" sm="5" md="5" lg="5" offset-md="1" offset-lg="1" v-for="logo in logos">
